...
class ViewController:
    ...
    def draw_model(self, model: Model, iteration):
        ...
        if self.view_type == ViewType.FIRE_FIGHTERS:
            ...
            for team in model.teams:
                ...
                View.window.blit(text, ((team.target_sector[1] * 10 + 2) * View.gap, (team.target_sector[0] * 10 + 2) * View.gap))
    ...
    def draw_fighters(self, fighters):
        for fighter in fighters:
            fighter.draw(View.window, View.gap, View.gap)
    ...
    def draw_timer(self, iteration):
        ...
        text = smallfont.render("{:.2f}".format(iteration / 15) + " min", True, Color.black)  # 360 it -> 12 min
